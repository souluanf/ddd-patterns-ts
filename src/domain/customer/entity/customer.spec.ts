...
describe("Customer unit tests", () => {
  ...
  it("should throw when street is empty", () => {
    expect(() => {
      const customer = new Customer("1", "Customer 1");
      customer.Address = new Address("", 123, "13330-250", "São Paulo");
  ...
  it("should throw when number is empty", () => {
    expect(() => {
      const customer = new Customer("1", "Customer 1");
      customer.Address = new Address("Street 1", 0, "13330-250", "São Paulo");
    }).toThrowError("Number is required");
  });

  it("should throw when zip is empty", () => {
    expect(() => {
      const customer = new Customer("1", "Customer 1");
      customer.Address = new Address("Street 1", 123, "", "São Paulo");
  ...
  it("should throw when city is empty", () => {
    expect(() => {
      const customer = new Customer("1", "Customer 1");
      customer.Address = new Address("Street 1", 123, "13330-250", "");
  ...
  it("should return address as string", () => {
    ...
    expect(customer.Address.toString()).toBe(
      "Street 1, 123, 13330-250 São Paulo",
    );
  });
  ...
  it("should throw error when address is undefined and activating a customer", () => {
    const customer = new Customer("1", "Customer 1");
  ...
  it("should activate customer with an address defined", () => {
    const customer = new Customer("1", "Customer 1");
    customer.changeAddress(
      new Address("Street 1", 123, "13330-250", "São Paulo"),
    );
